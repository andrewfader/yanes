...
int main(int argc, char **argv) {
  ...
  const System systems[] = {
      {"nes-pulse", DIV_SYSTEM_NES, 0},
      {"nes-triangle", DIV_SYSTEM_NES, 2},
      {"nes-noise", DIV_SYSTEM_NES, 3},
      {"gameboy-pulse", DIV_SYSTEM_GB, 0},
      {"gameboy-wave", DIV_SYSTEM_GB, 2},
      {"gameboy-noise", DIV_SYSTEM_GB, 3},
      {"sms-tone", DIV_SYSTEM_SMS, 0},
      {"sms-noise", DIV_SYSTEM_SMS, 3},
      {"pce-wave", DIV_SYSTEM_PCE, 0},
      {"ay-tone", DIV_SYSTEM_AY8910, 0},
      {"pokey-tone", DIV_SYSTEM_POKEY, 0},
      {"sid6581", DIV_SYSTEM_C64_6581, 0},
      {"sid8580", DIV_SYSTEM_C64_8580, 0},
      {"scc", DIV_SYSTEM_SCC, 0},
      {"saa1099", DIV_SYSTEM_SAA1099, 0},
      {"tia", DIV_SYSTEM_TIA, 0},
      {"vrc6-pulse", DIV_SYSTEM_VRC6, 0},
      {"vrc6-saw", DIV_SYSTEM_VRC6, 2},
      {"fds", DIV_SYSTEM_FDS, 0},
      {"n163", DIV_SYSTEM_N163, 0},
      {"vrc7", DIV_SYSTEM_VRC7, 0}};
